	...
	void getCurrentReservations(ConsultationPageConnection consultDB) {
		...
		txtCurrentReservationsSearch.textProperty().addListener((observable, oldValue, newValue) -> {
			filteredCurrentReservationsData.setPredicate(currentReservationsSearchModel -> {
				...
				if (currentReservationsSearchModel.getStrReservationId() != null && currentReservationsSearchModel
						.getStrReservationId().toLowerCase().indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else if (currentReservationsSearchModel.getEmail() != null && currentReservationsSearchModel
						.getEmail().toLowerCase().indexOf(searchScheduleKeyword) > -1) {
					return true;
					...
					return true;
				} else if (currentReservationsSearchModel.getBarCode() != null && currentReservationsSearchModel
						.getBarCode().toLowerCase().indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else if (currentReservationsSearchModel.getStrEndReservationDate() != null
						&& currentReservationsSearchModel.getStrEndReservationDate().toLowerCase()
								.indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else if (currentReservationsSearchModel.getStrEndReservationTime() != null
						&& currentReservationsSearchModel.getStrEndReservationTime().toLowerCase()
								.indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else {
					return false;
		...
		SortedList<ModelAllReservationsTable> sortedCurrentReservationsData = new SortedList<>(
				filteredCurrentReservationsData);
	...
	void getReservationHistory(ConsultationPageConnection consultDB) {
		...
		txtReservationHistoryTable.textProperty().addListener((observable, oldValue, newValue) -> {
			filtedRedreservationHistoryData.setPredicate(reservationHistorySearchModel -> {
				...
				if (reservationHistorySearchModel.getStrReservationId() != null && reservationHistorySearchModel
						.getStrReservationId().toLowerCase().indexOf(searchScheduleKeyword) > -1) {
					return true;
					...
					return true;
				} else if (reservationHistorySearchModel.getBarCode() != null && reservationHistorySearchModel
						.getBarCode().toLowerCase().indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else if (reservationHistorySearchModel.getStrEndReservationDate() != null
						&& reservationHistorySearchModel.getStrEndReservationDate().toLowerCase()
								.indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else if (reservationHistorySearchModel.getStrEndReservationTime() != null
						&& reservationHistorySearchModel.getStrEndReservationTime().toLowerCase()
								.indexOf(searchScheduleKeyword) > -1) {
					return true;
				} else {
					return false;
		...
		SortedList<ModelAllReservationsTable> sortedReservationHistoryData = new SortedList<>(
				filtedRedreservationHistoryData);
